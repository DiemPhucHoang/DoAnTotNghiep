...
import { Link, Button, Grid, Paper, Card, CardActionArea, CardContent, Typography, CardActions, AppBar, Toolbar } from '@material-ui/core';
                    ...
                    <Card elevation={3} style={{ padding: '5px' }}>
                        <CardActionArea>
                            <div style={{ textAlign: 'center', padding: '15px' }}>
                                <img alt="avatar" src="image/avata.jpg" className="rounded-circle" style={{ width: '55%' }} />
                            </div>
                            <CardContent>
